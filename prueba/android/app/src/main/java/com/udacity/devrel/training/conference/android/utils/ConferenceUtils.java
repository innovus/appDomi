...
import com.appspot.miprueba_curso.conference.model.Conference;
import com.appspot.miprueba_curso.conference.model.ConferenceCollection;
import com.appspot.miprueba_curso.conference.model.Profile;
import com.appspot.miprueba_curso.conference.model.WrappedBoolean;
...
public class ConferenceUtils {
    ...
    private static com.appspot.miprueba_curso.conference.Conference sApiServiceHandler;
     ...
     * This list includes information about what {@link com.appspot.miprueba_curso.conference.model.Conference}s
    ...
    public static List<DecoratedConference> getConferences()
        ...
        com.appspot.miprueba_curso.conference.Conference.QueryConferences
    ...
    /**
     * Registers user for a {@link com.appspot.miprueba_curso.conference.model.Conference}
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean registerForConference(Conference conference)
        ...
        com.appspot.miprueba_curso.conference.Conference.ConferenceApi.RegisterForConference
                registerForConference = sApiServiceHandler.conferenceApi().registerForConference(
    ...
    /**
     * Unregisters user from a {@link com.appspot.miprueba_curso.conference.model.Conference}.
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean unregisterFromConference(Conference conference)
        ...
        com.appspot.miprueba_curso.conference.Conference.UnregisterFromConference
    ...
    /**
     * Returns the user {@link com.appspot.miprueba_curso.conference.model.Profile}. Can
    ...
    public static Profile getProfile() throws ConferenceException, IOException {
        ...
        com.appspot.miprueba_curso.conference.Conference.GetProfile getProfile =
                sApiServiceHandler.getProfile();
        return getProfile.execute();
    }

    /**
     * Build and returns an instance of {@link com.appspot.miprueba_curso.conference.Conference}
     *
     * @param context
     * @param email
     * @return
     */
    public static com.appspot.miprueba_curso.conference.Conference buildServiceHandler(
            Context context, String email) {
        GoogleAccountCredential credential = GoogleAccountCredential.usingAudience(
                context, AppConstants.AUDIENCE);
        credential.setSelectedAccountName(email);

        com.appspot.miprueba_curso.conference.Conference.Builder builder
                = new com.appspot.miprueba_curso.conference.Conference.Builder(
