...
/**
 * Created by personal on 23/03/15.
 */
public class MenuSliderAdapter extends RecyclerView.Adapter<MenuSliderAdapter.ViewHolder> {
    ...
    public MenuSliderAdapter(String Titles[], int Icons[],Context context){ // MyAdapter Constructor with titles and icons parameter
    ...
    @Override
    public MenuSliderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_cajon_menu,parent,false); //Inflating the layout
    ...
    @Override
    public void onBindViewHolder(MenuSliderAdapter.ViewHolder holder, int position) {
